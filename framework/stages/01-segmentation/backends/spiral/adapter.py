...
# mirrored here rather than imported: the runner invokes the fitter as a
# subprocess in its own interpreter, so this adapter never imports
...
SCROLL_SPEC_PATH_OVERRIDE_KEYS = (
    "umbilicus", "fibers", "fiber_directions", "outer_shell", "tracks_dbm",
    "normal_x", "normal_y", "gradient_magnitude", "surf_sdt",
    "winding_inference",
)
